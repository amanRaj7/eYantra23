...
class DroneController():
    def __init__(self,node):
        ...
        self.changeit = 0
        self.it = 0
        self.set_points = [[0,0,28],[0, 0, 23], [2,3,23], [-1,2,25], [-3,-3,25], [0,0,30]]         # Setpoints for x, y, z respectively    
    ...
    def publish_data_to_rpi(self, roll, pitch, throttle):
        ...
        if(limit_throttle < 1350) or (self.drone_position[2]>30.7) and self.is_landing:
            self.disarm()
